...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($name_err) && empty($role_err) && empty($administrator_err)){
        ...
        $sql = "UPDATE roleadministrator1 SET name=?, role=?, administrator=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssi", $param_name, $param_role, $param_administrator, $param_id);
